...
crear archivo que guarde el siguiente codigo py:
...
for name in cookies:
	...
	r=requests.get("http://mercury.picoctf.net:65344/display",cookies={"session":cookie},allow_redirects=False)
...
Posteriormente, ejecutar en consola, lee todos los valores de cookies y al final muestra un html y ahí viene la bandera


```


## Respuesta: **picoCTF{pwn_4ll_th3_cook1E5_25bdb6f6}**